@echo off
chcp 65001 >nul
title JADA Fit - Configurar IA Local
cls
...
if not exist "%SERVER_EXE%" (
    ...
    powershell -Command "& {
        ...
        Invoke-WebRequest -Uri 'https://github.com/ggml-org/llama.cpp/releases/download/b4628/llama-b4628-bin-win-avx2-x64.zip' -OutFile $zip
